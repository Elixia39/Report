    ...
    <div class="row">
        <div class="col col-md-4">
            <nav class="panel panel-default">
                <div class="panel-heading">フォルダ | <a class="btn btn-primary" href="{{ route('home') }}">カレンダー画面へ</a></div>
            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <div class="text-right">
                        <a class="btn btn-primary btn-block" href="{{ route('reports.create',['folder' => $current_folder_id]) }}">日報を作成する</a>
                    </div>
                </div>
                <table class="table" style="table-layout: fixed">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td><span class="label ">{{ $report->am_condition_label}}</span></td>
                            <td><span class="label ">{{ $report->pm_condition_label}}</span></td>
